package org.pahappa.systems.core.services.base.impl;
...
/**
 * Abstract Base class for all Service interface Implementations and abstracts<br/>
 *
 * @param <T> The entity type for which the service is being implemented
 * @version 1.0
 */
@Transactional
public abstract class GenericServiceImpl<T extends BaseEntity> extends BaseDAOImpl<T> implements GenericService<T> {
    ...
    private void changeStatusToDeleted(T instance) {
        CustomLogger.log(getClass(), LogSeverity.LEVEL_DEBUG, String.format("Instance is deletable! Now setting the audit trail."));
